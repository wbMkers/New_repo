...
BEGIN
	...
	BEGIN
		...
		SELECT ProcessDefId, ExtMethodIndex FROM ExtMethodDefTable WHERE ExtAppType != 'S' 
		OPEN cursor1
		...
		BEGIN 
			...
			SELECT @v_STR6 = ' UPDATE RuleOperationTable SET Param1 = Convert(Nvarchar(20), (Convert(INT, Param1) + 1000)) WHERE ProcessDefId = ' + Convert(Nvarchar(20), @ProcessDefId) + ' AND OperationType = 22 '
			SELECT @v_STR7 = ' UPDATE RuleOperationTable SET Param2 = Convert(Nvarchar(20), (Convert(INT, Param2) + 1000))  WHERE ProcessDefId = ' + Convert(Nvarchar(20), @ProcessDefId) + ' AND OperationType = 23 '
	...
	SELECT DISTINCT ProcessDefId FROM ExtMethodDefTable   
	OPEN cursor1
	...
	BEGIN
		...
		BEGIN
			BEGIN TRANSACTION trans
				EXECUTE('INSERT INTO ExtMethodDefTable VALUES(' +@ProcessDefId+ ',' +@ExtMethodIndex+ ',N''' +@v_ExtAppName+ ''', N''' +@v_ExtAppType+ ''', N''contains'', NULL, NULL, 12, NULL)')
				EXECUTE('INSERT INTO ExtMethodParamDefTable VALUES(' +@ProcessDefId+ ', 1,' +@ExtMethodIndex+ ', N''Param1'', 10, 1, NULL, NULL, N''N'')')
				EXECUTE('INSERT INTO ExtMethodParamDefTable VALUES(' +@ProcessDefId+ ', 2,' +@ExtMethodIndex+ ', N''Param2'', 10, 2, NULL, NULL, N''N'')')
			COMMIT TRANSACTION trans
		END
		...
		BEGIN
			BEGIN TRANSACTION trans
				EXECUTE('INSERT INTO ExtMethodDefTable VALUES(' +@ProcessDefId+ ',' +@ExtMethodIndex+ ',N''' +@v_ExtAppName+ ''', N''' +@v_ExtAppType+ ''', N''normalizeSpace'', NULL, NULL, 10, NULL)')
				EXECUTE('INSERT INTO ExtMethodParamDefTable Values(' +@ProcessDefId+ ', 1,' +@ExtMethodIndex+ ', N''Param1'', 10, 1, NULL, NULL, N''N'')')
			COMMIT TRANSACTION trans
		END
		...
		BEGIN
			BEGIN TRANSACTION trans
				EXECUTE('INSERT INTO ExtMethodDefTable VALUES(' +@ProcessDefId+ ',' +@ExtMethodIndex+ ',N''' +@v_ExtAppName+ ''', N''' +@v_ExtAppType+ ''', N''stringValue'', NULL, NULL, 10, NULL)')
				EXECUTE('INSERT INTO ExtMethodParamDefTable Values(' +@ProcessDefId+ ', 1,' +@ExtMethodIndex+ ',N''Param1'', 10, 1, NULL, NULL, N''N'')')
			COMMIT TRANSACTION trans
		END
		...
		BEGIN
			BEGIN TRANSACTION trans
				EXECUTE('INSERT INTO ExtMethodDefTable VALUES(' +@ProcessDefId+ ',' +@ExtMethodIndex+ ',N''' +@v_ExtAppName+ ''', N''' +@v_ExtAppType+ ''', N''stringValue'', NULL, NULL, 10, NULL)')
				EXECUTE('INSERT INTO ExtMethodParamDefTable Values(' +@ProcessDefId+ ', 1,' +@ExtMethodIndex+ ',N''Param1'', 8, 1, NULL, NULL, N''N'')')
			COMMIT TRANSACTION trans
		END
		...
		BEGIN
			BEGIN TRANSACTION trans
				EXECUTE('INSERT INTO ExtMethodDefTable VALUES(' +@ProcessDefId+ ',' +@ExtMethodIndex+ ',N''' +@v_ExtAppName+ ''', N''' +@v_ExtAppType+ ''', N''stringValue'', NULL, NULL, 10, NULL)')
				EXECUTE('INSERT INTO ExtMethodParamDefTable Values(' +@ProcessDefId+ ', 1,' +@ExtMethodIndex+ ',N''Param1'', 6, 1, NULL, NULL, N''N'')')
			COMMIT TRANSACTION trans
		END
		...
		BEGIN
			BEGIN TRANSACTION trans
				EXECUTE('INSERT INTO ExtMethodDefTable VALUES(' +@ProcessDefId+ ',' +@ExtMethodIndex+ ',N''' +@v_ExtAppName+ ''', N''' +@v_ExtAppType+ ''', N''stringValue'', NULL, NULL, 10, NULL)')
				EXECUTE('INSERT INTO ExtMethodParamDefTable Values(' +@ProcessDefId+ ', 1,' +@ExtMethodIndex+ ',N''Param1'', 4, 1, NULL, NULL, N''N'')')
			COMMIT TRANSACTION trans
		END
		...
		BEGIN
			BEGIN TRANSACTION trans
				EXECUTE('INSERT INTO ExtMethodDefTable VALUES(' +@ProcessDefId+ ',' +@ExtMethodIndex+ ',N''' +@v_ExtAppName+ ''', N''' +@v_ExtAppType+ ''', N''stringValue'', NULL, NULL, 10, NULL)')
				EXECUTE('INSERT INTO ExtMethodParamDefTable Values(' +@ProcessDefId+ ', 1,' +@ExtMethodIndex+ ',N''Param1'', 3, 1, NULL, NULL, N''N'')')
			COMMIT TRANSACTION trans
		END
		...
		BEGIN
			BEGIN TRANSACTION trans
				EXECUTE('INSERT INTO ExtMethodDefTable VALUES(' +@ProcessDefId+ ',' +@ExtMethodIndex+ ',N''' +@v_ExtAppName+ ''', N''' +@v_ExtAppType+ ''', N''stringValue'', NULL, NULL, 10, NULL)')
				EXECUTE('INSERT INTO ExtMethodParamDefTable Values(' +@ProcessDefId+ ', 1,' +@ExtMethodIndex+ ',N''Param1'', 12, 1, NULL, NULL, N''N'')')
			COMMIT TRANSACTION trans
		END
		...
		BEGIN
			BEGIN TRANSACTION trans
				EXECUTE('INSERT INTO ExtMethodDefTable VALUES(' +@ProcessDefId+ ',' +@ExtMethodIndex+ ',N''' +@v_ExtAppName+ ''', N''' +@v_ExtAppType+ ''', N''booleanValue'', NULL, NULL, 12, NULL)')
				EXECUTE('INSERT INTO ExtMethodParamDefTable Values(' +@ProcessDefId+ ', 1,' +@ExtMethodIndex+ ',N''Param1'', 10, 1, NULL, NULL, N''N'')')
			COMMIT TRANSACTION trans
		END	  
		...
		BEGIN
			BEGIN TRANSACTION trans
				EXECUTE('INSERT INTO ExtMethodDefTable VALUES(' +@ProcessDefId+ ',' +@ExtMethodIndex+ ',N''' +@v_ExtAppName+ ''', N''' +@v_ExtAppType+ ''', N''startsWith'', NULL, NULL, 12, NULL)')
				EXECUTE('INSERT INTO ExtMethodParamDefTable Values(' +@ProcessDefId+ ', 1,' +@ExtMethodIndex+ ', N''Param1'', 10, 1, NULL, NULL, N''N'')')
				EXECUTE('INSERT INTO ExtMethodParamDefTable Values(' +@ProcessDefId+ ', 2,' +@ExtMethodIndex+ ',N''Param2'', 10, 2, NULL, NULL, N''N'')')
			COMMIT TRANSACTION trans
		END
		...
		BEGIN
			BEGIN TRANSACTION trans
				EXECUTE('INSERT INTO ExtMethodDefTable VALUES(' +@ProcessDefId+ ',' +@ExtMethodIndex+ ',N''' +@v_ExtAppName+ ''', N''' +@v_ExtAppType+ ''', N''stringLength'', NULL, NULL, 3, NULL)')
				EXECUTE('INSERT INTO ExtMethodParamDefTable Values(' +@ProcessDefId+ ', 1,' +@ExtMethodIndex+ ',N''Param1'', 10, 1, NULL, NULL, N''N'')')
			COMMIT TRANSACTION trans
		END
		...
		BEGIN
			BEGIN TRANSACTION trans
				EXECUTE('INSERT INTO ExtMethodDefTable VALUES(' +@ProcessDefId+ ',' +@ExtMethodIndex+ ',N''' +@v_ExtAppName+ ''', N''' +@v_ExtAppType+ ''', N''subString'', NULL, NULL, 10, NULL)')
				EXECUTE('INSERT INTO ExtMethodParamDefTable Values(' +@ProcessDefId+ ', 1,' +@ExtMethodIndex+ ',N''Param1'', 10, 1, NULL, NULL, N''N'')')
				EXECUTE('INSERT INTO ExtMethodParamDefTable Values(' +@ProcessDefId+ ', 2,' +@ExtMethodIndex+ ',N''Param2'', 3, 2, NULL, NULL, N''N'')')
				EXECUTE('INSERT INTO ExtMethodParamDefTable Values(' +@ProcessDefId+ ', 3,' +@ExtMethodIndex+ ',N''Param3'', 3, 3, NULL, NULL, N''N'')')
			COMMIT TRANSACTION trans
		END
		...
		BEGIN
			BEGIN TRANSACTION trans
				EXECUTE('INSERT INTO ExtMethodDefTable VALUES(' +@ProcessDefId+ ',' +@ExtMethodIndex+ ',N''' +@v_ExtAppName+ ''', N''' +@v_ExtAppType+ ''', N''subStringBefore'', NULL, NULL, 10, NULL)')
				EXECUTE('INSERT INTO ExtMethodParamDefTable Values(' +@ProcessDefId+ ', 1,' +@ExtMethodIndex+ ',N''Param1'', 10, 1, NULL, NULL, N''N'')')
				EXECUTE('INSERT INTO ExtMethodParamDefTable Values(' +@ProcessDefId+ ', 2,' +@ExtMethodIndex+ ',N''Param2'', 10, 2, NULL, NULL, N''N'')')
			COMMIT TRANSACTION trans
		END
		...
		BEGIN
			BEGIN TRANSACTION trans
				EXECUTE('INSERT INTO ExtMethodDefTable VALUES(' +@ProcessDefId+ ',' +@ExtMethodIndex+ ',N''' +@v_ExtAppName+ ''', N''' +@v_ExtAppType+ ''', N''subStringAfter'', NULL, NULL, 10, NULL)')
				EXECUTE('INSERT INTO ExtMethodParamDefTable Values(' +@ProcessDefId+ ', 1,' +@ExtMethodIndex+ ', N''Param1'', 10, 1, NULL, NULL, N''N'')')
				EXECUTE('INSERT INTO ExtMethodParamDefTable Values(' +@ProcessDefId+ ', 2,' +@ExtMethodIndex+ ', N''Param2'', 10, 2, NULL, NULL, N''N'')')
			COMMIT TRANSACTION trans
		END
		...
		BEGIN
			BEGIN TRANSACTION trans
				EXECUTE('INSERT INTO ExtMethodDefTable VALUES(' +@ProcessDefId+ ',' +@ExtMethodIndex+ ',N''' +@v_ExtAppName+ ''', N''' +@v_ExtAppType+ ''', N''translate'', NULL, NULL, 10, NULL)')
				EXECUTE('INSERT INTO ExtMethodParamDefTable Values(' +@ProcessDefId+ ', 1,' +@ExtMethodIndex+ ', N''Param1'', 10, 1, NULL, NULL, N''N'')')
				EXECUTE('INSERT INTO ExtMethodParamDefTable Values(' +@ProcessDefId+ ', 2,' +@ExtMethodIndex+ ', N''Param2'', 10, 2, NULL, NULL, N''N'')')
				EXECUTE('INSERT INTO ExtMethodParamDefTable Values(' +@ProcessDefId+ ', 3,' +@ExtMethodIndex+ ', N''Param3'', 10, 3, NULL, NULL, N''N'')')
			COMMIT TRANSACTION trans
		END
		...
		BEGIN
			BEGIN TRANSACTION trans
				EXECUTE('INSERT INTO ExtMethodDefTable VALUES(' +@ProcessDefId+ ',' +@ExtMethodIndex+ ',N''' +@v_ExtAppName+ ''', N''' +@v_ExtAppType+ ''', N''concat'', NULL, NULL, 10, NULL)')
				EXECUTE('INSERT INTO ExtMethodParamDefTable Values(' +@ProcessDefId+ ', 1,' +@ExtMethodIndex+ ', N''Param1'', 10, 1, NULL, NULL, N''N'')')
				EXECUTE('INSERT INTO ExtMethodParamDefTable Values(' +@ProcessDefId+ ', 2,' +@ExtMethodIndex+ ', N''Param2'', 10, 2, NULL, NULL, N''N'')')
			COMMIT TRANSACTION trans
		END
		...
		BEGIN
			BEGIN TRANSACTION trans
				EXECUTE('INSERT INTO ExtMethodDefTable VALUES(' +@ProcessDefId+ ',' +@ExtMethodIndex+ ',N''' +@v_ExtAppName+ ''', N''' +@v_ExtAppType+ ''', N''numberValue'', NULL, NULL, 6, NULL)')
				EXECUTE('INSERT INTO ExtMethodParamDefTable Values(' +@ProcessDefId+ ', 1,' +@ExtMethodIndex+ ', N''Param1'', 10, 1, NULL, NULL, N''N'')')
			COMMIT TRANSACTION trans
		END
		...
		BEGIN
			BEGIN TRANSACTION trans
				EXECUTE('INSERT INTO ExtMethodDefTable VALUES(' +@ProcessDefId+ ',' +@ExtMethodIndex+ ',N''' +@v_ExtAppName+ ''', N''' +@v_ExtAppType+ ''', N''round'', NULL, NULL, 4, NULL)')
				EXECUTE('INSERT INTO ExtMethodParamDefTable Values(' +@ProcessDefId+ ', 1,' +@ExtMethodIndex+ ', N''Param1'', 6, 1, NULL, NULL, N''N'')')
			COMMIT TRANSACTION trans
		END
		...
		BEGIN
			BEGIN TRANSACTION trans
				EXECUTE('INSERT INTO ExtMethodDefTable VALUES(' +@ProcessDefId+ ',' +@ExtMethodIndex+ ',N''' +@v_ExtAppName+ ''', N''' +@v_ExtAppType+ ''', N''floor'', NULL, NULL, 4, NULL)')
				EXECUTE('INSERT INTO ExtMethodParamDefTable Values(' +@ProcessDefId+ ', 1,' +@ExtMethodIndex+ ', N''Param1'', 6, 1, NULL, NULL, N''N'')')
			COMMIT TRANSACTION trans
		END
		...
		BEGIN
			BEGIN TRANSACTION trans
				EXECUTE('INSERT INTO ExtMethodDefTable VALUES(' +@ProcessDefId+ ',' +@ExtMethodIndex+ ',N''' +@v_ExtAppName+ ''', N''' +@v_ExtAppType+ ''', N''ceiling'', NULL, NULL, 4, NULL)')
				EXECUTE('INSERT INTO ExtMethodParamDefTable Values(' +@ProcessDefId+ ', 1,' +@ExtMethodIndex+ ', N''Param1'', 6, 1, NULL, NULL, N''N'')')
			COMMIT TRANSACTION trans
		END
		...
		IF @v_found = 0
		BEGIN
			EXECUTE('INSERT INTO ExtMethodDefTable VALUES(' +@ProcessDefId+ ',' +@ExtMethodIndex+ ',N''' +@v_ExtAppName+ ''', N''' +@v_ExtAppType+ ''', N''getCurrentDate'', NULL, NULL, 15, NULL)')
		END
		...
		IF @v_found = 0
		BEGIN
			EXECUTE('INSERT INTO ExtMethodDefTable VALUES(' +@ProcessDefId+ ',' +@ExtMethodIndex+ ',N''' +@v_ExtAppName+ ''', N''' +@v_ExtAppType+ ''', N''getCurrentTime'', NULL, NULL, 16, NULL)')
		END
		...
		IF @v_found = 0
		BEGIN
			EXECUTE('INSERT INTO ExtMethodDefTable VALUES(' +@ProcessDefId+ ',' +@ExtMethodIndex+ ',N''' +@v_ExtAppName+ ''', N''' +@v_ExtAppType+ ''', N''getCurrentDateTime'', NULL, NULL, 8, NULL)')
		END
		...
		BEGIN
			BEGIN TRANSACTION trans
				EXECUTE('INSERT INTO ExtMethodDefTable VALUES(' +@ProcessDefId+ ',' +@ExtMethodIndex+ ',N''' +@v_ExtAppName+ ''', N''' +@v_ExtAppType+ ''', N''getShortDate'', NULL, NULL, 15, NULL)')
				EXECUTE('INSERT INTO ExtMethodParamDefTable Values(' +@ProcessDefId+ ', 1,' +@ExtMethodIndex+ ', N''Param1'', 8, 1, NULL, NULL, N''N'')')
			COMMIT TRANSACTION trans
		END
		...
		BEGIN
			BEGIN TRANSACTION trans
				EXECUTE('INSERT INTO ExtMethodDefTable VALUES(' +@ProcessDefId+ ',' +@ExtMethodIndex+ ',N''' +@v_ExtAppName+ ''', N''' +@v_ExtAppType+ ''', N''getTime'', NULL, NULL, 16, NULL)')
				EXECUTE('INSERT INTO ExtMethodParamDefTable Values(' +@ProcessDefId+ ', 1,' +@ExtMethodIndex+ ', N''Param1'', 8, 1, NULL, NULL, N''N'')')
			COMMIT TRANSACTION trans
		END
		...
		BEGIN
			BEGIN TRANSACTION trans
				EXECUTE('INSERT INTO ExtMethodDefTable VALUES(' +@ProcessDefId+ ',' +@ExtMethodIndex+ ',N''' +@v_ExtAppName+ ''', N''' +@v_ExtAppType+ ''', N''roundToInt'', NULL, NULL, 3, NULL)')
				EXECUTE('INSERT INTO ExtMethodParamDefTable Values(' +@ProcessDefId+ ', 1,' +@ExtMethodIndex+ ', N''Param1'', 6, 1, NULL, NULL, N''N'')')
			COMMIT TRANSACTION trans
		END
		...
		BEGIN
			BEGIN TRANSACTION trans
				EXECUTE('INSERT INTO ExtMethodDefTable VALUES(' +@ProcessDefId+ ',' +@ExtMethodIndex+ ',N''' +@v_ExtAppName+ ''', N''' +@v_ExtAppType+ ''', N''getElementAtIndex'', NULL, NULL, 3, NULL)')
				EXECUTE('INSERT INTO ExtMethodParamDefTable Values(' +@ProcessDefId+ ', 1,' +@ExtMethodIndex+ ', N''Param1'', 3, 1, NULL, NULL, N''N'')')
				EXECUTE('INSERT INTO ExtMethodParamDefTable Values(' +@ProcessDefId+ ', 2,' +@ExtMethodIndex+ ',N''Param2'', 3, 2, NULL, NULL, N''N'')')
			COMMIT TRANSACTION trans
		END
		...
		BEGIN
			BEGIN TRANSACTION trans
				EXECUTE('INSERT INTO ExtMethodDefTable VALUES(' +@ProcessDefId+ ',' +@ExtMethodIndex+ ',N''' +@v_ExtAppName+ ''', N''' +@v_ExtAppType+ ''', N''addElementToArray'', NULL, NULL, 3, NULL)')
				EXECUTE('INSERT INTO ExtMethodParamDefTable Values(' +@ProcessDefId+ ', 1,' +@ExtMethodIndex+ ', N''Param1'', 3, 1, NULL, NULL, N''N'')')
				EXECUTE('INSERT INTO ExtMethodParamDefTable Values(' +@ProcessDefId+ ', 2,' +@ExtMethodIndex+ ', N''Param2'', 3, 2, NULL, NULL, N''N'')')
				EXECUTE('INSERT INTO ExtMethodParamDefTable Values(' +@ProcessDefId+ ', 3,' +@ExtMethodIndex+ ', N''Param3'', 3, 3, NULL, NULL, N''N'')')
			COMMIT TRANSACTION trans
