 ...
 */
public class WFBeanSerializerFactory extends BaseSerializerFactory {

    protected transient TypeDesc typeDesc = null;
    protected transient BeanPropertyDescriptor[] propertyDescriptor = null;

    public WFBeanSerializerFactory(Class javaType, QName xmlType) {
        super(WFBeanSerializer.class, xmlType, javaType);
        init(javaType);
    ...
    protected Serializer getGeneralPurpose(String mechanismType) {
        ...
        return new WFBeanSerializer(javaType, xmlType, typeDesc,
                                  propertyDescriptor);
    }
