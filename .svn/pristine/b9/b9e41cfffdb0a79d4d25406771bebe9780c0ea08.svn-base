...
//Module					: Beans
//File Name					: WMQueueLocalHome.java	
//Author					: Ashish Mangla
//Date written (DD/MM/YYYY)	: 06/12/2004
//Description				: It represents the Home Interface of the WMQueue Bean.
//----------------------------------------------------------------------------------------------------
//			CHANGE HISTORY
//----------------------------------------------------------------------------------------------------
...
public interface WMQueueLocalHome extends WFTransactionHome
{
