...
//Module					: Beans
//File Name					: WMGroupLocalHome.java	
//Author					: Ashish Mangla
//Date written (DD/MM/YYYY)	: 04/12/2004
//Description				: It represents the Home Interface of the GroupBean.
//----------------------------------------------------------------------------------------------------
//			CHANGE HISTORY
//----------------------------------------------------------------------------------------------------
...
public interface WMGroupLocalHome extends WFTransactionHome
{
