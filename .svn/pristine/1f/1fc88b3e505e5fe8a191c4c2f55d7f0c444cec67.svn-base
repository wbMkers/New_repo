...
01/04/2014		Shweta Singhal	Change done for Code Optimization
16/09/2014      Kanika Manik	       PRD Bug 47588 - To Provide support for displaying total number of workItems and pages while click on Queue or Seaching from Advance search functionality.
...
Create OR Replace Function WFSearchMove( 
	v_QueryStr		VARCHAR
) 
RETURNS void AS $$
DECLARE 
	
	v_CursorSearchTable	REFCURSOR; 
	v_DBStatus		INT;
...
Begin 
	OPEN v_CursorSearchTable FOR EXECUTE TO_CHAR(v_QueryStr); 
	LOOP
		BEGIN
			FETCH v_CursorSearchTable Into v_PROCESSINSTANCEID, v_QUEUENAME, v_PROCESSNAME, v_PROCESSVERSION,  
				...
				v_ExpectedWorkitemDelay, v_PROCESSEDBY, v_Q_USERID, v_WORKITEMSTATE, v_ACTIVITYTYPE,v_URN,v_VAR_INT1, v_VAR_INT2, 
				v_VAR_INT3, v_VAR_INT4, v_VAR_INT5, v_VAR_INT6, v_VAR_INT7, v_VAR_INT8, v_VAR_FLOAT1, v_VAR_FLOAT2, 
				v_VAR_DATE1, v_VAR_DATE2 ,v_VAR_DATE3, v_VAR_DATE4,v_VAR_DATE5, v_VAR_DATE6, v_VAR_LONG1, v_VAR_LONG2, v_VAR_LONG3, v_VAR_LONG4, v_VAR_LONG5, v_VAR_LONG6,
				v_VAR_STR1, v_VAR_STR2, v_VAR_STR3, v_VAR_STR4, v_VAR_STR5, v_VAR_STR6, v_VAR_STR7, v_VAR_STR8,v_VAR_STR9, v_VAR_STR10, v_VAR_STR11, v_VAR_STR12, v_VAR_STR13, v_VAR_STR14, v_VAR_STR15, v_VAR_STR16, v_VAR_STR17, v_VAR_STR18, v_VAR_STR19, v_VAR_STR20, 
				v_VAR_REC1, v_VAR_REC2, v_VAR_REC3, v_VAR_REC4, v_VAR_REC5;
			EXIT WHEN NOT FOUND; 

			    INSERT INTO TempSearchTable(PROCESSINSTANCEID,QUEUENAME,PROCESSNAME,PROCESSVERSION,ACTIVITYNAME,STATENAME,CHECKLISTCOMPLETEFLAG,ASSIGNEDUSER,ENTRYDATETIME,VALIDTILL ,WORKITEMID,PRIORITYLEVEL,PARENTWORKITEMID,PROCESSDEFID,ACTIVITYID,INSTRUMENTSTATUS,LOCKSTATUS,LOCKEDBYNAME,CREATEDBYNAME,CREATEDDATETIME,LOCKEDTIME,INTRODUCTIONDATETIME,INTRODUCEDBY,ASSIGNMENTTYPE,PROCESSINSTANCESTATE,QUEUETYPE,STATUS,Q_QUEUEID,TURNAROUNDTIME,	REFERREDBY,	REFERREDTO,	EXPECTEDPROCESSDELAYTIME,EXPECTEDWORKITEMDELAYTIME,PROCESSEDBY,
                Q_USERID,WORKITEMSTATE,ACTIVITYTYPE,URN,VAR_INT1,VAR_INT2,VAR_INT3,VAR_INT4,VAR_INT5,VAR_INT6,VAR_INT7,VAR_INT8,VAR_FLOAT1,VAR_FLOAT2,VAR_DATE1,VAR_DATE2,VAR_DATE3,VAR_DATE4,VAR_DATE5, VAR_DATE6,VAR_LONG1,VAR_LONG2,VAR_LONG3,	VAR_LONG4,VAR_LONG5, VAR_LONG6,VAR_STR1,VAR_STR2,VAR_STR3,VAR_STR4,VAR_STR5,VAR_STR6,VAR_STR7,VAR_STR8,VAR_STR9, VAR_STR10, VAR_STR11, VAR_STR12, VAR_STR13, VAR_STR14,VAR_STR15, VAR_STR16, VAR_STR17, VAR_STR18,VAR_STR19, VAR_STR20,VAR_REC_1,VAR_REC_2,	VAR_REC_3,VAR_REC_4,VAR_REC_5)
