					...
					BEGIN TRANSACTION MOVE_QUEUE_HISTORY_DATA ------------------------------Move Trans Data Begins Here
						...
						BEGIN
							...
							BEGIN
									...
									SELECT @v_query = 'Insert into QUEUEHISTORYTABLE('+ @colStr + ') Select ' + @colStr + ' from ' +  @dblinkString + '.QUEUEHISTORYTABLE where processinstanceid = '+''''+ @v_processInstanceId + ''''									
									EXECUTE(@v_query)
									...
									BEGIN
										...
										BEGIN
											...
											SELECT @v_query = 'INSERT INTO ' + @v_externalTable + '('+ @colStr + ') SELECT '+ @colStr +' FROM ' + @dblinkString + '.' + @v_externalTable + ' WHERE ITEMINDEX = ' + @v_folderIndex
										...
										BEGIN
											...
											SELECT @v_query = 'INSERT INTO ' + @v_externalTableHistory + '('+ @colStr +') SELECT '+ @colStr +' FROM ' + @dblinkString + '.' + @v_externalTableHistory + ' WHERE ITEMINDEX = ' + @v_folderIndex
