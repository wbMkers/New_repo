...
CREATE OR REPLACE PROCEDURE AllUPGRADE AS 
	...
	v_msgCount		INTEGER;
	v_logStatus 	BOOLEAN;
	v_scriptName    NVARCHAR2(100) := 'Upgrade09_SP00_008';
...
BEGIN
	...
	v_logStatus := LogInsert(1,'Calling Procedures MultipleExceptionProc,ProcessTATProc,ActivityTATProc,EscalationProc');
	BEGIN
