 ...
 */
public class WFBeanSerializer implements Serializer, Serializable {

    protected static Log log =
        LogFactory.getLog(WFBeanSerializer.class.getName());
    ...
    public WFBeanSerializer(Class javaType, QName xmlType) {
        this(javaType, xmlType, TypeDesc.getTypeDescForClass(javaType));
    }

    // Construct BeanSerializer for the indicated class/qname
    public WFBeanSerializer(Class javaType, QName xmlType, TypeDesc typeDesc) {
        ...
        throws IOException
    {
        ...
        try {
            ...
            for(int cnt = 0; cnt < fields.length; cnt++){
                String fieldName = fields[cnt].getName();
